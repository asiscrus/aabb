var CanvasChart = function() {
    ...
    var renderChart = function() {
        ...
        if (data.renderTypes == undefined || data.renderTypes == null) data.renderTypes = [
            renderType.lines
        ];
        for(var i = 0; i < data.renderTypes.length; i++)renderData(data.renderTypes[i]);
    };
    var getMaxDataYValue = function() {
        for(var i = 0; i < data.dataPoints.length; i++)if (data.dataPoints[i].y > maxYValue) maxYValue = data.dataPoints[i].y;
    };
    ...
    var renderData = function(type) {
        ...
        for(var i = 0; i < data.dataPoints.length; i++){
            ...
            if (i > 0 && type == renderType.lines) //Draw connecting lines
...
//# sourceMappingURL=index.6abe3bd9.js.map
